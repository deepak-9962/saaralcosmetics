/**
 * fetch-products-content.js
 * Fetches all product descriptions, ingredients, how_to_use for review.
 */
...
async function main() {
  ...
  url.searchParams.set("select", "id,name,slug,description,ingredients,how_to_use");
  ...
  data.forEach((p) => {
    ...
    console.log(`INGR: ${p.ingredients}`);
    console.log(`HOW:  ${p.how_to_use}`);
  });
}
